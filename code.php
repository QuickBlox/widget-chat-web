...
if ($appId && $authKey && $authSecret && $roomJid && $chatTitle) {
	...
	if ($token != '') {
		...
		$generatedCode = array('success' => true,
													 ...
													 'code' => "<div id='qb-xmppchat'><iframe src='http://quickblox.com/applications/xmppchat/app.php?key=$key' frameborder=0 height=100% width=100%></iframe></div>");
	} else {
